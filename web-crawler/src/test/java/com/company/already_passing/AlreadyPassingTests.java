...
public class AlreadyPassingTests extends TestCase {
    ...
    public static void testCrawl() throws Exception {
        ...
        assertEquals(crawler.graph.get("https://www.triplebyte.com").requestType, RequestType.GET);
        assertNotEquals(crawler.graph.parents(new URI("http://triplebyte.com/careers")).size(), 0);
    }
}
